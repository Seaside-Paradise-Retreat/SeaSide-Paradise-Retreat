  ...
  ('Chic Lounge Oasis', 'Deluxe',100, 0, 'Premium service along with a wide range of amenities will bring you the experience of the most fulfilling vacation.The 24-hour reception desk is always ready to serve you from check-in to check-out or any requests.', 5),
  ...
  ('Artistic Lounge Retreat', 'View',80, 1, 'Artistic Lounge Retreat is a unique and creative art space where you can relax and find inspiration. With its distinctive design and unique artistic decoration, this space offers a memorable space ', 5),

  ('Artistic Lounge Retreat', 'View',80, 1, 'Artistic Lounge Retreat is a unique and creative art space where you can relax and find inspiration. With its distinctive design and unique artistic decoration.', 5),
  ('Artistic Lounge Retreat', 'View',80, 1, 'Artistic Lounge Retreat is a unique and creative art space where you can relax and find inspiration. With its distinctive design and unique artistic decoration, this space offers a memorable.', 5),
  ('Artistic Lounge Retreat', 'View',80, 1, 'Artistic Lounge Retreat is a unique and creative art space where you can relax and find inspiration. With its distinctive design and unique artistic decoration, this space offers a memorable space.', 5),
  ('Artistic Lounge Retreat', 'View',80, 1, 'Artistic Lounge Retreat is a unique and creative art space where you can relax and find inspiration. With its distinctive design and unique artistic decoration, this space offers a memorable space.', 5),
  ('Artistic Lounge Retreat', 'View',80, 1, 'Artistic Lounge Retreat is a unique and creative art space where you can relax and find inspiration. With its distinctive design and unique artistic decoration, this space offers a memorable space ', 5),
...
INSERT INTO Booking (id_room, id_user, check_in_date, check_out_date)
VALUES 
    (1, 1, '2023-01-01', '2023-01-03'),
    (2, 2, '2023-02-10', '2023-02-15'),
    (3, 3, '2023-03-20', '2023-03-25'),
    (4, 4, '2023-04-05', '2023-04-07'),
    (1, 2, '2023-05-15', '2023-05-20');

INSERT INTO Bill (id_booking, date, total_price)
VALUES 
    (1, '2023-01-03', 50),
    (2, '2023-02-15', 100),
    (3, '2023-03-25', 120),
...
INSERT INTO Feedback (id_room, id_user, rating, content, date)
VALUES 
    (1, 1, 5, 'Great experience!', '2023-01-04'),
    (2, 2, 4, 'Nice place to stay.', '2023-02-16'),
    (3, 3, 3, 'Average service.', '2023-03-26'),
    (4, 4, 2, 'Disappointing experience.', '2023-04-08'),
    (1, 2, 4, 'Good value for money.', '2023-05-21');


INSERT INTO Booking_history (id_booking, id_user, id_bill)
VALUES 
    (1, 1, 1),
    (2, 2, 2),
    (3, 3, 3),
