...
{
    global $connection;
    $query = "SELECT booking.id, booking.availability, booking.check_in_date,booking.check_out_date, users.name, rooms.id AS room_id, rooms.name AS room_name, rooms.price, rooms.description, bill.total_price, bill.date
    FROM users
