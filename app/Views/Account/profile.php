...
<link rel="stylesheet" href="../../../public/css/profile.css">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" class="btn btn-close button_cancel custom-btn" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        
        <div class="modal-body">
          <form>
            <div class="mb-3">
              <label for="name" class="title">UserName:</label>
            ...
            <div class="mb-3">
              <label for="phone" class="title">PhoneNumber:</label>
  ...
  <!-- body -->
  <div class="contents ">
    <h1 class="tilte-form">Hi example !</h1>
    ...
    <div class="row content_profile-usernames">
      <div class="col-lg-4 content_profile-usernames-about">
        ...
        <div class="edit-avata-user">
          <img id="avata-user" src="../../Assets/images/person02.jpg" alt="avatar">
        </div>
        <!--Upload avatar-->
        <div class="edit-avata-user"> 
      ...
      <div class="col-lg-5 content_profile-username-email-password" style="margin-top: 30px;">
        ...
        <input type="text" class="form-input-profile" name="user-name" id="user_name" style="padding-left: 20px;"placeholder="User name" value="Example" readonly>

        <label for="" class="title">Email</label>
        <input type="text" class="form-input-profile" name="email" id="email11" style="padding-left: 20px;" placeholder="Email" value="Example@gmail.com" readonly>
