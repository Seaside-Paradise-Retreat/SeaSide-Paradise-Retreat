...
<div class="row g-4 ml-2 mb-5 listroom" id="pp">
    ...
    <div>
        <div class="room-item">
        <button class="btn-card-navigation-previous btn-previous" onclick="showPreviousCards()">&lt;</button>
        </div>
    </div>
              ...
              <div class="room-item">
                <div class="position-relative">
                  <a href="hotel_rooms_page.html">
                    <img class="img-fluid" src="../../Assets/images/Duluxe_room.jpg" alt="">
                  </a>
                  <i class="fas fa-heart position-absolute bottom-0 end-0 m-3 " style="font-size: 24px;color:white;"></i>
                </div>
                <div class="mt-2">
                  <div class="d-flex justify-content-between mb-1">
                    <h5 class="mb-0">Duluxe</h5>
                    <div class="ps-2">
                        <div id="ratingContainer">
                            <?php include '../../Models/evaluate.php'; ?>
                        </div>
                    </div>
                  </div>
                  <p>The Deluxe room is a luxurious and spacious hotel accommodation, featuring modern amenities and stunning city views. It provides guests with a memorable and indulgent experience.</p>
